...
<html>
    ...
    <body>
        ...
        <aside class="navegacao-solicitacao"> <!-- Tag que indica menu de auxilio da pagina (vale como div) -->
            <h1 class="titulo-navegacao">Solicitação</h1>
            <nav> <!-- Tag para semantica (navegadores reconhecem links) -->
                <ul>
        ...
        <aside class="navegacao-lancamento">
            ...
            <nav> <!-- Tag usada para agregar maior semantica (navegadores saberem que se tratam de links) -->
                <ul>
